...
#model.fit(final_train_images, final_train_labels, epochs=150, batch_size=25, validation_split=0.15, callbacks=[early_stopping])
...
# 모델 저장
model.save('./model/cnn_model_38.h5')