import random
import numpy as np
from keras.layers import Dropout, BatchNormalization, AveragePooling2D
...
model.fit(final_train_images, final_train_labels, epochs=45, batch_size=30, validation_split=0.15)

loss, accuracy = model.evaluate(final_test_images, final_test_labels, verbose=1)
print('Test Accuracy:', accuracy)

# 모델 저장
model.save('./model/cnn_model_40.h5')