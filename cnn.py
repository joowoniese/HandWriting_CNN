...
hand_images = hand_images.reshape((-1, 28, 28, 1))
hand_images = hand_images.astype('float32') / 255.0
...
model.fit(final_test_images, final_test_labels, epochs=50, batch_size=30, validation_split=0.15)
...
# 모델 저장
model.save('./model/cnn_model_0.h5')
